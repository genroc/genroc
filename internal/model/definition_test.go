			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					OnError:  []ErrorCase{{Code: []string{"pre.%"}, Retry: Retries(3)}},
				},
			}},
			wantErr: "",
		},
			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					Switch:   SwitchMap{{Goto: GotoEnd}},
					OnlyOnce: boolPtr(true),
					OnError:  []ErrorCase{{Code: []string{"pre.error", "pre.timeout"}, Retry: Retries(3)}},
				},
			}},
			wantErr: "",
		},
			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					Switch:   SwitchMap{{Goto: GotoEnd}},
					OnlyOnce: boolPtr(true),
					OnError:  []ErrorCase{{Code: []string{"http.422"}, NotReached: boolPtr(true), Retry: Retries(2)}},
				},
			}},
			wantErr: "",
		},
			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					Switch:   SwitchMap{{Goto: GotoEnd}},
					OnlyOnce: boolPtr(true),
					OnError:  []ErrorCase{{NotReached: boolPtr(true), Retry: Retries(2)}},
				},
			}},
			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					Switch:   SwitchMap{{Goto: GotoEnd}},
					OnlyOnce: boolPtr(true),
					OnError:  []ErrorCase{{Code: []string{"http.500"}, Retry: Retries(1)}},
				},
			}},
			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					Switch:   SwitchMap{{Goto: GotoEnd}},
					OnlyOnce: boolPtr(true),
					OnError:  []ErrorCase{{Code: []string{"http.%"}, Retry: Retries(1)}},
				},
			}},
			wantErr: `pattern "http.%" can match errors where the call may have executed`,
		},
			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					Switch:   SwitchMap{{Goto: GotoEnd}},
					OnlyOnce: boolPtr(true),
					OnError:  []ErrorCase{{Retry: Retries(2)}},
				},
			}},
			wantErr: "a catch-all rule cannot have retries on an only_once task",
		},
			...
			def: ProcessDefinition{Name: "p", Tasks: []*Task{
				{
					...
					Switch:   SwitchMap{{Goto: GotoEnd}},
					OnlyOnce: boolPtr(true),
					OnError:  []ErrorCase{{Code: []string{"pre.%", "http.%"}, Retry: Retries(1)}},
				},
			}},
			wantErr: `pattern "http.%" can match errors where the call may have executed`,
		},

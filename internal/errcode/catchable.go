...
var catchable = []Info{
	...
	{OutputParse, KindFetch, "the response body was not valid JSON"},
	{OutputTooLarge, KindFetch, "the response body exceeded the size a fetch will read"},
	{OutputInvalid, KindFetch | KindChild, "the result did not satisfy the schema declared for it"},

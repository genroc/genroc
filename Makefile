...
# The `.genroc` schema the manifest points at is generated by package.json's vscode:prepublish,
# which vsce runs before packaging whoever invokes it -- release.yml does not go through here.
extension:

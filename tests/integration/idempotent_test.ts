      ...
      tasks: [
        {
          ...
          on_error: [{ case: ["pre.4%"], not_reached: true, retries: 3, goto: "end" } as any],
          switch: [{ goto: "end" }],
        },
      ],
    },
      ...
      tasks: [
        {
          ...
          only_once: true,
          action: { type: "fetch" as const, url: "http://localhost:19990/x" },
          on_error: [{ code: ["http.%"], not_reached: true, retries: 2 }],
          switch: [{ goto: "end" }],
        },
      ],
    },
      ...
      tasks: [
        {
          ...
          only_once: true,
          action: { type: "fetch" as const, url: "http://localhost:19990/x" },
          on_error: [{ code: ["http.timeout"], not_reached: true, retries: 2 }],
          switch: [{ goto: "end" }],
        },
      ],
    },
      ...
      tasks: [
        {
          ...
          on_error: [
            { code: ["pre.%"], retries: 3 },
            { code: ["http.409", "http.422"], not_reached: true, retries: 2 },
          ],
          switch: [{ goto: "end" }],
        },
      ],
